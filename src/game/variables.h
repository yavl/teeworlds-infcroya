...
MACRO_CONFIG_STR(SvMotd, sv_motd, 900, "InfCroya\n\nInfection mod with class system based on InfClass\n\nSources: https://github.com/yavl/teeworlds-infcroya", CFGFLAG_SAVE|CFGFLAG_SERVER, "Message of the day to display for the clients") // INFCROYA RELATED
