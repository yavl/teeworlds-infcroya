...
function infc_init()
	...
	case = math.random(1, 10) -- 10 different cases
	if case == 1 then
		circle_positions = { 
			-- x, y, radius, minradius
			114, 125, default_radius, min_radius, circle_shrink_speed,
		}
	end
	...
	if case == 2 then
		circle_positions = { 
			-- x, y, radius, minradius
			144, 120, default_radius, min_radius, circle_shrink_speed,
		}
	end
	...
	if case == 3 then
		circle_positions = { 
			-- x, y, radius, minradius
			45, 126, default_radius, min_radius, circle_shrink_speed,
		}
	end
	...
	if case == 4 then
		circle_positions = { 
			-- x, y, radius, minradius
			75, 125, default_radius, min_radius, circle_shrink_speed,
		}
	end
	...
	if case == 5 then
		circle_positions = { 
			-- x, y, radius, minradius
			128, 82, default_radius, min_radius, circle_shrink_speed,
		}
	end
	...
	if case == 6 then
		circle_positions = { 
			-- x, y, radius, minradius
			121, 59, default_radius, min_radius, circle_shrink_speed,
		}
	end
	...
	if case == 7 then
		circle_positions = { 
			-- x, y, radius, minradius
			183, 71, default_radius, min_radius, circle_shrink_speed,
		}
	end
	...
	if case == 8 then
		circle_positions = { 
			-- x, y, radius, minradius
			172, 21, default_radius, min_radius, circle_shrink_speed,
		}
	end
	...
	if case == 9 then
		circle_positions = { 
			-- x, y, radius, minradius
			96, 108, default_radius, min_radius, circle_shrink_speed,
		}
	end
	...
	if case == 10 then
		circle_positions = { 
			-- x, y, radius, minradius
			31, 53, default_radius, min_radius, circle_shrink_speed,
		}
	end
end
